...
1. To clone the repository:
   ...
   - If you do not have Git, click the green ```Code``` button in the upper right-hand corner. There should be a drop down, click ```download ZIP```. Once downloaded, unZIP the folder and place it somewhere accessible such as the desktop. 
3. Add the desired hardpoints by either changing:
...
4. Open the ```kinematics_model.ipynb``` file, or if you want to compare two sets of hardpoints, use ```kinematic_report_comparisons.ipynb```
5. Run cells sequentially to build the kinematic arrays, analyze results, and visualize.
